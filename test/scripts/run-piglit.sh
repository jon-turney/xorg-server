...
python3 $PIGLIT_DIR/piglit-summary.py -s $PIGLIT_RESULTS_DIR > $SHORT_SUMMARY
python3 $PIGLIT_DIR/piglit-summary.py $PIGLIT_RESULTS_DIR > $LONG_SUMMARY
...
python3 $PIGLIT_DIR/piglit-summary-html.py \
	--overwrite \
